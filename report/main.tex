...
construct is based on the farm building block, therefore the performance should be comparable.
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{figures/64k/total-time.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.6\textwidth]{figures/64M/total-time.png}
...
\begin{figure}[H]
        \centering
        \includegraphics[width=0.7\textwidth]{figures/64M-nomap/total-time.png}
        \caption{execution time with 50mb file (no I/O)}
